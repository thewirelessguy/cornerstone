<?php
/**
 * The default template for displaying blog cards full width layout.
 *
		...
		<div id="primary" class="auto cell site-content">
			<main id="content">
				...
				<?php if ( have_posts() ) :
					...
					<div class="grid-x small-up-1 medium-up-2 large-up-3" data-equalizer="cards" data-equalize-on="medium" data-equalize-by-row="true">
