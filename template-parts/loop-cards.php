<?php
/**
 * The default template for displaying blog cards layout.
 *
		...
		<div id="primary" class="auto cell site-content">
			<main id="content" role="main">
				...
				<?php if ( have_posts() ) :
					...
					<div class="grid-x small-up-1 medium-up-2" data-equalizer="cards" data-equalize-on="medium" data-equalize-by-row="true">
